...
res.soma        <- paste0("zcat /home/mdp50/rds/rds-rjh234-mrc-epid/Studies/People/Ellie/Olink/GWAS/output/formatted/combined/",
                          soma,"_withMarkerName.out.gz",
...
## add names
names(res.soma)          <- c("chr", "rsid", "pos", "Allele2", "Allele1", "Freq1", "info", "Effect", "StdErr", "tval", "log10p", "MarkerName")
## add sample size and Pvalue
res.soma$TotalSampleSize <- 485
res.soma$Pvalue          <- 10^-res.soma$log10p
## keep only needed
